...
//let sub = '';// 留空则显示原版内容
let sub = 'no-tls-dy.yyg6680.workers.dev';// 内置优选订阅生成器，可自行搭建 https://github.com/cmliu/WorkerVless2sub
let subconverter = 'api.v1.mk';// clash订阅转换后端，目前使用肥羊的订阅转换功能。自带虚假uuid和host订阅。
let subconfig = "https://raw.githubusercontent.com/3152/my_firat/main/clash/clash.ini"; //订阅配置文件
